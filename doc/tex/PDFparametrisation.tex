...
\subsection{Log-Normal Functional Form}

A log-normal distribution is proposed by \cite{AndreSchoenig} to parameterise the x-dependence of the parton density function of the proton.
